...
declare namespace annie {
    ...
    class Shape {
         ...
         * @return {Image}
         */
        static convertToImage(bitmap: Texture): any;
        /**
         * 三次贝赛尔曲线
         * 从上一点画二次贝赛尔曲线到某一点,如果没有设置上一点，则上一占默认为(0,0)
...
declare namespace annie {
     ...
     * @since 1.0.0
     */
    class Media extends laya.events.EventDispatcher {
        /**
...
declare namespace Flash2x {
     ...
     * @returns {any}
     */
    function b(sceneName: string, imageName: string, isTexture?: boolean): any;
    /**
